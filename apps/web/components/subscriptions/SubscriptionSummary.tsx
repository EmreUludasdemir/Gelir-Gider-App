    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            {subscriptions.length > 4 && (
                <button className="mt-3 w-full py-2 text-center text-purple-600 dark:text-purple-400 font-medium text-sm hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-lg transition-colors">
