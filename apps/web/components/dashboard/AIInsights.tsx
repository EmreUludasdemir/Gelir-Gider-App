          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-display font-bold text-foreground text-base">
                {language === 'tr' ? 'Finansal Yapay Zeka Analizi' : 'AI Financial Insights'}
              </h3>
              <p className="text-xs text-muted-foreground/80 mt-0.5">
                {language === 'tr'
                  ? 'Gelişmiş AI motoru tarafından üretilen gerçek zamanlı bulgular'
                  : 'Real-time analysis points generated by AI Engine'}
              </p>
            </div>
          </div>
            ...
            {spendingInsights.length === 0 ? (
              <div className="text-center py-10">
                ...
                <p className="text-sm text-muted-foreground max-w-sm mx-auto">
                  {language === 'tr'
                    ? 'Hesap aktiviteleriniz analiz ediliyor. Veri akışı sağlandıkça AI önerileriniz burada belirecektir.'
                    : 'Your account activities are being analyzed. AI recommendations will appear as data flows.'}
                </p>
              </div>
            ) : (
            ...
            {spendingInsights.filter(i => i.potentialSavings && i.potentialSavings > 0).length > 0 ? (
              ...
              <div className="text-center py-10">
                ...
                <p className="text-sm text-muted-foreground max-w-xs mx-auto">
                  {language === 'tr'
                    ? 'Hesap harcamalarınız optimize ediliyor. AI tarafından belirlenecek tasarruf fırsatları burada listelenecektir.'
